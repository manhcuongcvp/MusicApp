package com.ldt.music.ui.widget.avsb;

import androidx.annotation.NonNull;
import androidx.annotation.WorkerThread;

import com.ldt.music.interactors.AppExecutors;
import com.ldt.music.interactors.MainThreadUtils;
...
class VisualSeekBarParser implements ProgressListener {
    ...
    protected com.ldt.music.ui.widget.soundfile.SoundFile mSoundFile;
    ...
    void parse(Song song) {
        AppExecutors.io().execute(() -> {
                    ...
                    try {
                        mSoundFile = com.ldt.music.ui.widget.soundfile.SoundFile.create(song, this);
                        //Thread.sleep(2500);
